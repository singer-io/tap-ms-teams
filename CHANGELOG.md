...
## 1.0.0
  * Add `handle_top_exception` decorator to `main()` for structured error logging and clean exit on unhandled exceptions. [#12](https://github.com/singer-io/tap-ms-teams/pull/12)
